		...
		<Box component="section" id="faq">
			<Container maxWidth="md">
				...
				<Accordion expanded={expanded === 'q1'} onChange={handleChange('q1')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q1-content" id="q1-header">
				...
				<Accordion expanded={expanded === 'q2'} onChange={handleChange('q2')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q2-content" id="q2-header">
				...
				<Accordion expanded={expanded === 'q3'} onChange={handleChange('q3')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q3-content" id="q3-header">
				...
				<Accordion expanded={expanded === 'q4'} onChange={handleChange('q4')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q4-content" id="q4-header">
						<Typography>Okay, but what can an NFT be?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>An NFT can represent almost anything such as:</Typography>
						<List>
							<ListItem>
								<ListItemIcon>
									<Collections />
				...
				<Accordion expanded={expanded === 'q5'} onChange={handleChange('q5')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q5-content" id="q5-header">
				...
				<Accordion expanded={expanded === 'q6'} onChange={handleChange('q6')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q6-content" id="q6-header">
						<Typography>What are the essential characteristics and benefits of NFTs?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q7'} onChange={handleChange('q7')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q7-content" id="q7-header">
						<Typography>
				...
				<Accordion expanded={expanded === 'q8'} onChange={handleChange('q8')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q8-content" id="q8-header">
				...
				<Accordion expanded={expanded === 'q9'} onChange={handleChange('q9')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q9-content" id="q9-header">
						<Typography>What are gas fees? Do I need gas to buy an NFT?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q10'} onChange={handleChange('q10')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q10-content" id="q10-header">
						<Typography>If I mint a lizard, how will I know what traits and attributes its art will have?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q11'} onChange={handleChange('q11')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q11-content" id="q11-header">
						<Typography>What if I want to sell my Lizard NFT sometime after I buy it?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q12'} onChange={handleChange('q12')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q12-content" id="q12-header">
						<Typography>What are secondary royalties, and how will they be used?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q13'} onChange={handleChange('q13')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q13-content" id="q13-header">
						<Typography>How do I help save the race of Lizards from extinction?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
				...
				<Accordion expanded={expanded === 'q14'} onChange={handleChange('q14')}>
					<AccordionSummary expandIcon={<ExpandMore />} aria-controls="q14-content" id="q14-header">
						<Typography>Other questions you&apos;d like us to add to this FAQ?</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography sx={styles.text}>
