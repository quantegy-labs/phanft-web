...
contract EnlightenedLizardsOld is ERC721, ERC721URIStorage, QuantegyLabsAccessControl {
	...
	fallback() external payable {
		require(msg.sender == address(ceoAddress) || msg.sender == address(ctoAddress), 'No tipping allowed');
	}
	...
	function mintLizard(address _phan, string memory _tokenURI) public payable returns (uint256) {
