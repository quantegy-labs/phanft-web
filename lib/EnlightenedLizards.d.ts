...
interface EnlightenedLizardsInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "claimPosterItem",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "claimWearableItem",
    values: [BigNumberish, string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setRightsProtocolAddr",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tokenToClaimedPosterItem",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "tokenToClaimedWearableItem",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "whitelistMintLizard",
...
export type NewLizardMintedEvent = TypedEvent<
  [BigNumber, string] & { tokenId: BigNumber; phan: string }
>;
...
export type PosterItemClaimedEvent = TypedEvent<
  [BigNumber, string] & { tokenId: BigNumber; phan: string }
>;
...
export type WearableItemClaimedEvent = TypedEvent<
  [BigNumber, string] & { tokenId: BigNumber; phan: string }
>;
...
export class EnlightenedLizards extends BaseContract {
  ...
  functions: {
    ...
    tokenToClaimedPosterItem(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;

    tokenToClaimedWearableItem(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
