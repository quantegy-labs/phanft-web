      ...
      <Layout>
        ...
        <Container maxWidth="md">
          ...
          <Typography sx={styles.missionText}>
            ...
            streams for creators and artists, by ensuring they get a percentage
            of every sale. Not just the initial sale. This was never possible
            before NFTs.
          </Typography>
          <Typography sx={styles.missionText}>
          ...
          <Typography sx={styles.missionText}>
            Welcome to a new digital paradigm with endless possibilities.
            Consider this your invitation to jump in the pond (with us here to
            guide you) as we create the greatest Phan community in the
            metaverse.
          </Typography>
        </Container>
      </Layout>
