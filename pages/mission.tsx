...
const MissionPage: NextPage = () => (
  <>
    ...
    <PageLayout pageTitle="Why PhanFT?" pageSubtitle="Our Mission Statement">
      <Typography sx={styles.missionText}>
        The way people interact and engage digitally is evolving faster than
        ever. We&apos;re at the forefront of a new era where art and artists can
        thrive in the digital world with complete transparency, authenticity,
        and preserved value.
      </Typography>
      <Typography sx={styles.missionText}>
        ...
        once again, and define what a passionate music community can do within
      ...
      <Typography sx={styles.missionText}>
        At PhanFT, each NFT artist will receive a royalty every time their work
        is bought and then re-sold on the blockchain. Now, instead of making a
        one-time sale on an art print, the artist will get a cut every time
        their work exchanges hands, for years and years to come.
      </Typography>
      <Typography sx={styles.missionText}>
        Welcome to a new digital paradigm with endless possibilities. Consider
        this your invitation to jump in the pond (with us here to guide you) as
        we create the greatest Phan community in the metaverse.
      </Typography>
    </PageLayout>
  </>
);
