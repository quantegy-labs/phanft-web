				...
				<Container maxWidth="lg">
					...
					<Paper sx={styles.paper} elevation={3}>
						...
						<Typography sx={styles.p}>
							If you’ve never purchased an NFT before and plan to purchase a PhanFT Enlightened Lizard, you’ll want to
							read this! NFTs are acquired in one of two ways. The first is via minting, which is the earliest stage you
							can buy an NFT. By minting a token, you bring it to life on the blockchain, shocking and persuading its
							metadata to ignite.
						</Typography>
						<Typography sx={styles.p}>
						...
						<Typography sx={styles.p}>
							...
							, follow the basic instructions, and you’re done! This NFT will live in a custodial wallet on Crossmint,
							until you choose to transfer it to a traditional NFT wallet where you hold the private keys, such as
							Metamask. We encourage you to transfer it to a Metamask wallet shortly after making your purchase.
						</Typography>
						...
						<Typography sx={styles.p}>
							...
							Gemini, or Binance. (Coinbase is likely your easiest experience and it’s a public company in the U.S. that
							is FDIC insured.)
						</Typography>
						<Typography sx={styles.p}>
							<u>Important note on ETH transfer delays:</u> if you don’t currently own any ETH, and need to buy some
							using fiat currency (such as U.S. Dollars), most of these cryptocurrency exchanges will let you trade
							...
							In this event, Coinbase (or another exchange you’re using) won’t let you transfer the ETH you have bought,
							from your wallet on that exchange into your Metamask wallet (or any external wallet) until those dollars
							have been deposited and cleared.
						</Typography>
						<Typography sx={styles.p}>
							This means, if you’re planning to mint, <u>and don’t currently own any ETH</u>, you should plan at least 5
							business days ahead of time to start the process and buy your ETH at Coinbase or your chosen exchange.
							This way, by 8/31 you’ll be able to transfer the required amount of ETH to your Metamask wallet so you can
							use it to mint.
						</Typography>
						<Typography sx={styles.p}>
							<strong>
								If you’re rolling your eyes at this already and it sounds like a pain, we highly recommend minting using
								your credit card via Crossmint.
							</strong>
						</Typography>
						...
						<Typography sx={styles.p}>
							When collecting an NFTs, you’ll need a digital wallet to store it in. We recommend using Metamask. Check
							out{' '}
							<Link
						...
						<ol>
							...
							<li>
								<Typography sx={styles.li}>Click "Install MetaMask for Chrome".</Typography>
							</li>
							<li>
								<Typography sx={styles.li}>
							...
							<li>
								<Typography sx={styles.li}>
									After you install the extension you will be redirected to a new page. Click "Create a Wallet."
								</Typography>
							</li>
							<li>
								<Typography sx={styles.li}>
							...
							<li>
								<Typography sx={styles.li}>
									...
									write it down in a few safe and secure area (like a safety deposit box) if you don’t want to have any
									trace of it recorded digitally. Never show or share this phrase with anyone! We will never ask you for
									your seed phrase and no legitimate entity or person will.
								</Typography>
							</li>
							...
							<li>
								<Typography sx={styles.li}>
									...
									and that will open your wallet. If your address isn't shown, you can also click the three dots to view
									"Account Details".
								</Typography>
							</li>
							<li>
						...
						<Typography sx={styles.p}>
							You’ll need to transfer some ethereum into your digital wallet. If you are buying ethereum on Coinbase and
						...
						<Typography sx={styles.p}>
							...
							enter the number of NFTs you want to buy. During the pre-sale you’ll be able to mint 1 per wallet address.
							During the public sale window you’ll be able to mint a max of 5 per wallet address.
						</Typography>
						<Typography sx={styles.p}>
							Metamask will pop open a dialog box, and you'll be able to see estimated gas fees and approve or reject
							the transaction. If you're okay with the fees, click “approve”.
						</Typography>
						<Typography sx={styles.p}>
						...
						<ol>
							...
							<li>
								<Typography sx={styles.li}>
									If this doesn’t work, go back to your NFTs tab, and click the blue highlighted text “Import NFTs” and
