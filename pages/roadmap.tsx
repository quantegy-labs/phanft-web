...
const RoadmapPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>PhanFT | Our Roadmap</title>
      </Head>
      <Layout>
        ...
        <Container maxWidth="md">
          ...
          <Typography sx={styles.roadmapText}>
            We&rsquo;ve set some milestones to keep us accountable and on-track
            to delivering this project&rsquo;s vision. As each percentage of
            Lizards sales is met below, we will start work on realizing that
            stated goal.
          </Typography>
          ...
          <Typography sx={styles.roadmapText}>
            We free 5 enslaved lizards (NFTs held back from the original sale)
            to be airdropped at random to existing Lizard holders.
          </Typography>
          <Typography variant="h4" sx={styles.roadmapHeading}>
            50%
          </Typography>
